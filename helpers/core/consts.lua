...
-- Rarity helpers
Pokerleven.set_base_rarities = function(common, uncommon, rare)
    G.GAME.common_mod = common or 0.69
    G.GAME.uncommon_mod = uncommon or 0.25
    G.GAME.rare_mod = rare or 0.05
end
