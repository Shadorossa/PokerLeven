            ...
            j_ina_NathanDark = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "cartas que necesite el {C:attention}Joker derecho{}.",
                        "{C:inactive}(Multi: {X:mult,C:white}X#3#{C:inactive} | Cargas: {C:attention}#1#/#2#{C:inactive}){}"
                    }
                }
            },
            j_ina_KevinDark = {
                ...
                text = {
                    ...
                    "Al vencer a la ciega {C:attention}Jefe{}, le {C:red}arranca{}",
