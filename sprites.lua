...
function loc_colour(_c, _default)
    ...
    -- === SAGA ALIUS (IE2) ===
    G.ARGS.LOC_COLOURS["ina_team_tormentadegeminis"] = HEX("441D68")
    ...
    G.ARGS.LOC_COLOURS["ina_team_diamonddust"] = HEX("AEE2F2")
    ...
    G.ARGS.LOC_COLOURS["ina_team_zoolanteam"] = HEX("212121")
    G.ARGS.LOC_COLOURS["ina_team_thekingdom"] = HEX("FDD835")
    G.ARGS.LOC_COLOURS["ina_team_littlegigant"] = HEX("C62828")
    G.ARGS.LOC_COLOURS["ina_team_littlegiants"] = HEX("C62828")
